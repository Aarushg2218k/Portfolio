...
const About = () => {
  ...
  return (
    <div className='px-7 md:px-10  sm:-mt-24 md:mt-[200px] lg:mt-[100px] ' id="about">
    ...
    <div className='flex flex-wrap ms-2 grid md:grid-cols-4 sm:grid-cols-2 lg:grid-cols-6'>
